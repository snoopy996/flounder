...
PROJECT_UUID=$(curl -s localhost:4500/api/projects \
  -H 'content-type: application/json' \
  -d "{\"name\":\"p\",\"providerId\":$DAYBREAK_PROFILE,\"daemonId\":1,\"dir\":\"p\"}" | jq -r .uuid)
