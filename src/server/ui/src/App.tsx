...
function decisionMetaChips(decision: ConfirmDecision): DecisionChip[] {
  ...
  return [
    ...
    summary ? { label: summary.technicalEvidence.riskAssessment.label, className: `label decision-gate decision-gate-${summary.technicalEvidence.riskAssessment.status === "assessed" ? "pass" : "open"}`, title: summary.technicalEvidence.riskAssessment.basis || "Current-state, principal-control, and likelihood assessment is incomplete." } : null,
